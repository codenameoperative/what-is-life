...
export const weaponsItems: Record<string, Item> = {
  ...
  steel_machete: {
    ...
    tier: 'uncommon',
    category: 'weapons',
    description: 'A razor-sharp steel machete perfect for close-quarters combat and jungle exploration.',
    value: 150,
    usable: false,
    source: 'Shop',
    breakChance: 0.03,
  ...
  composite_bow: {
    ...
    tier: 'uncommon',
    category: 'weapons',
    description: 'A modern compound bow with superior accuracy and power for hunting.',
    value: 200,
    usable: false,
    source: 'Shop',
    breakChance: 0.02,
  ...
  tactical_knife: {
    ...
    tier: 'uncommon',
    category: 'weapons',
    description: 'Military-grade tactical knife with multiple uses and exceptional durability.',
    value: 180,
    usable: false,
    source: 'Shop',
    breakChance: 0.025,
  ...
  enchanted_sword: {
    ...
    tier: 'rare',
    category: 'weapons',
    description: 'A sword imbued with mystical energy that never loses its edge.',
    value: 800,
    usable: false,
    source: 'Quest',
    breakChance: 0.005,
  ...
  plasma_rifle: {
    ...
    tier: 'rare',
    category: 'weapons',
    description: 'Futuristic energy weapon that fires superheated plasma bolts.',
    value: 1200,
    usable: false,
    source: 'WDYFT',
    breakChance: 0.001,
  ...
  diamond_katana: {
    ...
    tier: 'rare',
    category: 'weapons',
    description: 'A masterpiece katana forged from pure diamond - incredibly sharp and beautiful.',
    value: 1500,
    usable: false,
    source: 'Crafting',
    breakChance: 0.002,
  ...
  thunder_hammer: {
    ...
    tier: 'epic',
    category: 'weapons',
    description: 'Mjolnir\'s long-lost cousin - a hammer that calls down lightning with every strike.',
    value: 3000,
    usable: false,
    source: 'Legend',
    breakChance: 0.0005,
  ...
  neutron_sniper: {
    ...
    tier: 'epic',
    category: 'weapons',
    description: 'A sniper rifle that fires neutron beams capable of piercing any material.',
    value: 4500,
    usable: false,
    source: 'WDYFT',
    breakChance: 0.0002,
  ...
  soul_reaper: {
    ...
    tier: 'legendary',
    category: 'weapons',
    description: 'A legendary scythe that can harvest souls and bend reality itself.',
    value: 15000,
    usable: false,
    source: 'Underworld',
    breakChance: 0.00005,
  ...
  quantum_disruptor: {
    ...
    tier: 'legendary',
    category: 'weapons',
    description: 'A weapon that manipulates quantum fields to disintegrate targets at the atomic level.',
    value: 25000,
    usable: false,
    source: 'WDYFT',
    breakChance: 0.00001,
  ...
  reality_bender: {
    ...
    tier: 'mythical',
    category: 'weapons',
    description: 'A weapon of unimaginable power that can reshape reality itself.',
    value: 50000,
    usable: false,
    source: 'WDYFT',
  ...
  god_slaying_blade: {
    ...
    name: 'God-Slaying Blade',
    tier: 'mythical',
    category: 'weapons',
    description: 'The ultimate weapon capable of slaying gods and rewriting destiny.',
    value: 75000,
    usable: false,
    source: 'WDYFT',
  ...
  developer_wrath: {
    id: 'developer_wrath',
    name: 'Developer\'s Wrath',
    tier: 'wdyft',
    category: 'weapons',
    description: 'A weapon so powerful it can crash the entire game with a single thought.',
    value: 100000,
    usable: false,
    source: 'WDYFT',
  ...
  existence_eraser: {
    ...
    tier: 'wdyft',
    category: 'weapons',
    description: 'The final weapon - it doesn\'t just kill, it erases you from existence itself.',
    value: 999999,
    usable: false,
    source: 'WDYFT',
    breakChance: 0.0,
